...
const ISO_639_2_TO_1: Record<string, string> = {
  ...
  chi: 'zh', ara: 'ar', hin: 'hi', tha: 'th', vie: 'vi', tur: 'tr',
  pol: 'pl', nld: 'nl', dut: 'nl', swe: 'sv', nor: 'no', dan: 'da',
  fin: 'fi', ces: 'cs', cze: 'cs', slk: 'sk', slo: 'sk', ron: 'ro',
  rum: 'ro', hun: 'hu', bul: 'bg', hrv: 'hr', srp: 'sr', slv: 'sl',
  ukr: 'uk', ell: 'el', gre: 'el', heb: 'he', ind: 'id', msa: 'ms',
  may: 'ms', cat: 'ca', eus: 'eu', baq: 'eu', glg: 'gl',
};
