...
exports.ENGLISH_LANGUAGE = exports.UNKNOWN_LANGUAGE = exports.SUITARR_LANGUAGES = void 0;
exports.getSuitarrLanguageById = getSuitarrLanguageById;
exports.SUITARR_LANGUAGES = [
...
const byId = new Map(exports.SUITARR_LANGUAGES.map((l) => [l.id, l]));
function getSuitarrLanguageById(id) {
    return byId.get(id);
}
exports.UNKNOWN_LANGUAGE = exports.SUITARR_LANGUAGES.find((l) => l.id === 99);
exports.ENGLISH_LANGUAGE = exports.SUITARR_LANGUAGES.find((l) => l.id === 1);
//# sourceMappingURL=suitarr-languages.js.map