...
exports.DEFAULT_MOVIE_QUALITY_PROFILE_NAME = exports.SUITARR_QUALITIES = void 0;
exports.getSuitarrQualityById = getSuitarrQualityById;
exports.SUITARR_QUALITIES = [
...
const byId = new Map(exports.SUITARR_QUALITIES.map((q) => [q.id, q]));
function getSuitarrQualityById(id) {
    return byId.get(id);
}
exports.DEFAULT_MOVIE_QUALITY_PROFILE_NAME = 'HD-1080p (défaut)';
//# sourceMappingURL=suitarr-qualities.js.map