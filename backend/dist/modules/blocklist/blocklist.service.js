...
let BlocklistService = class BlocklistService {
    ...
    async remove(id) {
        ...
        if (!entry)
            throw new common_1.NotFoundException(`Blocklist entry #${id} not found`);
...
exports.BlocklistService = BlocklistService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(blocklist_entry_entity_1.BlocklistEntry)),
