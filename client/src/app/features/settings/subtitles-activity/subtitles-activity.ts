...
@Component({
  ...
  imports: [TvSelectDirective, TranslatePipe, LocaleDatePipe, LocalizeLanguagePipe, RouterLink, FormsModule, PaginationComponent, ErrorBadgeComponent, SubtitleStatusPipe],
